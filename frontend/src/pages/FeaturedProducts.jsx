...
const FeaturedProducts = () => {
  ...
  const fetchFeaturedProducts = async () => {
    try {
      setLoading(true);
      const response = await productService.getFeaturedProducts(currentPage, productsPerPage);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {products.length > 0 ? (
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-medium text-gray-900 mb-2">아직 인기상품이 없습니다</h3>
            <p className="text-gray-600">관리자가 인기상품을 지정하면 여기에 표시됩니다.</p>
          </div>
        )}
      </div>
    </div>
